...
server:
	gcc -Iinclude -Llib -o server src/tcpserver_threads.c src/handlers/playerhandler.c src/player/*.c src/network/*.c src/menu.c src/draw/media.c src/map/world.c -lmingw32 -lSDL2main -lSDL2 -lSDL2_image -lSDL2_net -lSDL2_mixer -lSDL2_ttf

...
void setSoldierSpeedUpTimer(Soldier s, int timer);
int getSoldierSpeedUpTimer(Soldier s);
void setSoldierMovementTimer(Soldier s, int timer);
int getSoldierMovementTimer(Soldier s);
